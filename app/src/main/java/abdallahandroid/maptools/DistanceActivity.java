...
import abdallahandroid.mapAbdo.APIKeysFreeGenerator;
import abdallahandroid.mapAbdo.IDowloadJSONFromAPI;
import abdallahandroid.mapAbdo.directionApi_routes.APIDirection_abdo;
import abdallahandroid.mapAbdo.distanceMatrixApi.DirectionMatrixAPI_abdo;

public class DistanceActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener  {


    private GoogleMap mMap;
    DirectionMatrixAPI_abdo distanceAdmin;
    EditText editText1;
    Button button1;
    Context mContext;
    Marker mMarker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                distanceAdmin.removeAllRoutesAndAllMarker();
            }
        });
...
//        freeQoutaDistanceGet();
    ...
    private void freeQoutaDistanceGet() {
        //direction
        String nextKeyFree = APIKeysFreeGenerator.getNextFreeeApi();
        distanceAdmin = new DirectionMatrixAPI_abdo(mMap, mContext, nextKeyFree);
        distanceAdmin.listennerResponse(new IDowloadJSONFromAPI() {
            @Override
            public void success_data() {
                System.out.println("abdoAminDrawRoutes - interface success_data() "  );
            }

            @Override
            public void faild_quota(Marker mark1, Marker mark2) {
                System.out.println("abdoAminDrawRoutes - interface faild_quota() "  );
                //try agin another key free
                String nextKeyFree = APIKeysFreeGenerator.getNextFreeeApi();
                if (nextKeyFree != null ){
                    //reinlize agin nextKeyFree variable
                    distanceAdmin = new DirectionMatrixAPI_abdo(mMap, mContext, nextKeyFree);
                    //draw mark 1
                    distanceAdmin.map_putTwoMarker_manger(mark1);
                    //draw mark 2
                    distanceAdmin.map_putTwoMarker_manger(mark2);

                } else {
                    Toast.makeText(mContext, "Sorry, free Qouta of using map have been finished.", Toast.LENGTH_SHORT).show();
                }
            }


            @Override
            public void faild_response() {
                System.out.println("abdoAminDrawRoutes - interface faild_response() "  );
                Toast.makeText(mContext, "there where problem while download", Toast.LENGTH_SHORT).show();
            }
        });
...
//    }
    ...
    public void map_drawLine_polyLineBetweenTwoPoint_manger(Marker mSerachToAdd){
        ...
        if (m1SerachBetween2Marker == null ) {
            ...
            //create agin
            m1SerachBetween2Marker = mSerachToAdd;
            System.out.println("map - drawLine  after add  m1 agin:" + m1SerachBetween2Marker );
        }
    }
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                ...
                try {
                    ...
                    //map_drawLine_polyLineBetweenTwoPoint_manager(markerReturn);
                    ...
                    //determine DistanceActivity
                    distanceAdmin.map_putTwoMarker_manger(markerReturn);
