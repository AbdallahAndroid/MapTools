    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                routesAmdin.removeAllRoutesAndAllMarker();
            }
        });
...
//        freeQoutaDrawingDirection();
    ...
    private void freeQoutaDrawingDirection() {
        //direction
        String nextKeyFree = APIKeysFreeGenerator.getNextFreeeApi();
        routesAmdin = new APIDirection_abdo(mMap, mContext, nextKeyFree);
        routesAmdin.listennerResponse(new IDowloadJSONFromAPI() {
            @Override
            ...
            public void faild_quota(Marker mark1, Marker mark2) {
                ...
                if (nextKeyFree != null ){
                    ...
                    routesAmdin = new APIDirection_abdo(mMap, mContext, nextKeyFree);
                    //draw mark 1
                    routesAmdin.map_drawroutes_BetweenTwoPoint_manger(mark1);
                    //draw mark 2
                    routesAmdin.map_drawroutes_BetweenTwoPoint_manger(mark2);
            ...
            public void onMapLongClick(LatLng latLng) {
                ...
                try {
                   ...
                   ///### map_drawLine_circle_manager(markerReturn, latLng, 1000, true);
                    ...
                    //DistanceActivity between two point
